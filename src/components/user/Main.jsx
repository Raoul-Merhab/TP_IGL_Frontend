...
const Main = ({cookie}) => {
    ...
    return (
        ...
        {
            step === "Article" &&
            <UserPage cookie={cookie} value={value} setValue={setValue} toSearch={searchToResult} results={results} setResults={setResults} onClickSearch={searchToResult} article={article} backToResults={backToResults} />
        }
        </>
    )
}
