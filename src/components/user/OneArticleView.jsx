...
const OneArticleView = ({article, articles, setArticles}) => {
	...
	const onClickConsulter = async () =>{
		await onClickTelecharger()
	}
	return (
		<div className=" bg-aa-gris px-7 py-4 w-full">
			...
			<div className="flex flex-row sm:flex-col md:flex-col lg:flex-row justify-between items-center pt-3">
				...
				<div className="uppercase bg-[#B38B59] font-semibold text-white px-8 py-2 cursor-pointer hover:bg-[#B38B59]/[0.8] transition-colors duration-[0.2s]" onClick={onClickConsulter}>
					Consulter
				</div>
			</div>
		</div>
